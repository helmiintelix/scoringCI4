...
class Common_model extends Model
{
	...
	function get_all_ref_master_crm($fieldName, $tableName, $criteria, $orderBy, $header = FALSE)
	{
		$this->crm = db_connect('crm');
		$arrData = array();
		...
		if ($query->getNumRows()) {
			foreach ($query->getResult() as $row) {
				$arrData[$row->reference][$row->value] = $row->item;
			}
		}
	...
	function get_ref_master_crm($fieldName, $tableName, $criteria, $orderBy, $header = FALSE)
	{
		$this->crm = db_connect('crm');
		$arrData = array();

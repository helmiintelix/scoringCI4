	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3 ">
				...
				<input type="text" id="id" name="id" class="form-control form-control-sm mandatory"/>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">WA Phone Number</label>
				<input type="text" id="phone" name="phone" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">Password</label>
				<input type="text" id="password" name="password" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				...
				<div style="display: flex; align-items: center;">
                    <?php
                        ...
                        echo form_dropdown('list_agent[]', $list_agent, '', $attributes);
                    ?>
                </div>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">Url</label>
				<input type="text" id="url" name="url" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">EXPIRED DATE</label>
				<input type="text" id="expired_date" name="expired_date" class="form-control form-control-sm mandatory" required/>
			</div>
			...
			<div class="mb-3 " style="<?= (getenv('TYPE_WA') === 'long_number') ? 'display:show;' : 'display:none;'; ?>">
				...
				<input type="text" id="server" name="server" class="form-control form-control-sm" />
			</div>
...
<script src="<?= base_url(); ?>modules/setup_wa_number/js/setup_wa_number_add.js?v=<?= rand() ?>"></script>
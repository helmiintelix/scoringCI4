	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3 ">
				...
				<input type="text" id="txt-lov-id" name="txt-lov-id" class="form-control form-control-sm mandatory" required/>
			</div>
			
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">LoV Description</label>
				<input type="text" id="txt-lov-name" name="txt-lov-name" class="form-control form-control-sm mandatory" required />
			</div>
			...
			<div class="mb-3 ">
				...
				<?php
                    ...
                    echo form_dropdown('opt-lov_category', $get_category,'', $attributes);
				?>
			</div>

            <div class="mb-3 ">
            <label for="form-field-select-2" class="fs-6 text-capitalize">Hirarki <span class="fw-bold"> *Semakin tinggi angka, maka semakin rendah hirarkinya</span></label>				
            <?php
                    $attributes = 'class="form-control form-control-sm mandatory" id="opt-lov_hirarki" data-placeholder ="[select]" required';
                    echo form_dropdown('opt-lov_hirarki', $get_hirarki_list,'', $attributes);
				?>
			</div>

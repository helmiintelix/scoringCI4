...
<div class="row">
    ...
    <div class="col-xs-12">
        <div class="btn-group  btn-group-sm" role="group" aria-label="Basic outlined example">
            <button type="button" class="btn btn-outline-success" id="btn-edit-relation">Edit</button>
        </div>
    </div>
</div>
<div class="card">
...
<script src="<?= base_url(); ?>modules/setup_list_of_value/js/setup_list_of_value.js?v=<?= rand() ?>"></script>
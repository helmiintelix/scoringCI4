	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3 ">
				...
				<input type="text" id="txt-branch-id" name="txt-branch-id" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">Area Branch Name</label>
				<input type="text" id="txt-branch-name" name="txt-branch-name" class="form-control form-control-sm mandatory" required />
			</div>
            ...
            <div class="mb-3 ">
				...
				<?php
                    ...
                    echo form_dropdown('opt-area_branch-city', $options, "", $attributes);
				?>
			</div>
            <div class="mb-3 ">
				...
				<?php
                    ...
                    echo form_dropdown('opt-area_branch-kecamatan', $options, "", $attributes);
				?>
			</div>
            <div class="mb-3 ">
				...
				<?php
                    ...
                    echo form_dropdown('opt-area_branch-kelurahan', $options, "", $attributes);
				?>
			</div>
			<div class="mb-3 ">
				...
				<?php
                    ...
                    echo form_dropdown('opt-area_branch-branch_list[]', $branch_list,'', $attributes);
				?>
			</div>
            <div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">Area Branch Address</label>
				<input type="text" id="txt-branch-address" name="txt-branch-address" class="form-control form-control-sm " />
			</div>
            
            <div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">Area Branch No.Telp</label>
				<input type="text" id="txt-branch-telp" name="txt-branch-telp" class="form-control form-control-sm " />
			</div>
            <div class="mb-3 ">

<?php
namespace App\Modules\Inventory90\models;

use App\Models\Common_model;
use CodeIgniter\Model;

Class Inventory_90_model Extends Model 
{
    ...
    function get_recovery_list(){
        ...
        //karena column fin_account di table cpcrd_ext tidak ada jadi joinnya yocki tutup dulu
        // $this->builder->join('cpcrd_ext as b', 'a.fin_account = b.fin_account','LEFT');
		$this->builder->where('DPD between 89 and 181');

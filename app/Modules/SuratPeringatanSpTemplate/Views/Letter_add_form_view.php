    ...
    <div class="row">
        <div class="col col-sm-12">
            ...
            <div class="mb-3" id="rules_ptp">
				...
				echo form_dropdown('opt-template-product-code[]', $product, '', $attributes);
				?>
            </div>
            <div class="mb-3">
                <div class="row">
            ...
            <div class="mb-3">
                <textarea maxlength="50" class="form-control form-control-sm mandatory" name="txt-letter-content"
                    id="txt-letter-content" style="height: 300px;"></textarea>
            </div>
...
<script src="<?= base_url(); ?>modules/surat_peringatan_sp_template/js/script_add_form.js?v=<?= rand() ?>"></script>
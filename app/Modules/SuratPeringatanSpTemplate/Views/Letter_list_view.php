...
<div class="card">
    ...
    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridSpt" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/surat_peringatan_sp_template/js/surat_peringatan_sp_template.js?v=<?= rand() ?>">
</script>
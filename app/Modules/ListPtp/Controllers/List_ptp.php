<?php 
namespace App\Modules\ListPtp\Controllers;
use App\Modules\ListPtp\Models\List_ptp_model;
use CodeIgniter\Cookie\Cookie;
use DateTime;

class List_ptp extends \App\Controllers\BaseController
{

	function __construct()
	{
		$this->List_ptp_model = new List_ptp_model();
	}
	...
	function index(){
		...
		// dd($data);
		return view('\App\Modules\ListPtp\Views\Report_janji_bayar_view', $data);
	}
	function get_report_janji_bayar_list(){
		$dataInput['tgl_from'] = '';
		$dataInput['tgl_to'] = '';
		...
		// print_r($dataInput);
		// exit();
		$data = $this->List_ptp_model->get_report_janji_bayar_list($dataInput);
	    if ($data) {

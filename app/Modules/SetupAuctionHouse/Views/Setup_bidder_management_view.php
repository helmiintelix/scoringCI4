...
<div class="card">
    ...
    <div class="card-header">
        Setup Bidder Management
    </div>

    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridSbm" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/setup_auction_house/js/setup_bidder_management.js?v=<?= rand() ?>"></script>
	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3">
				...
				<input type="text" id="txt_word" name="txt_word" class="form-control form-control-sm mandatory" placeholder="gunakan ' ; ' untuk menambah kata lebih dari 1" value="<?= $data_template['word'] ?>" required/>
			</div>
			<div class="mb-3 ">
...
<script src="<?= base_url(); ?>modules/setup_wa_filter_word/js/setup_wa_filter_word_edit.js?v=<?= rand() ?>"></script>
	...
	<div class="row">
		<div class="col col-sm-6">
			<div class="mb-3 ">
				...
				<input type="text" id="txt-user-id-temp" name="txt-user-id-temp" class="form-control form-control-sm mandatory" required/>
			</div>
			

			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">user name</label>
				<input type="text" id="txt-user-name" name="txt-user-name" class="form-control form-control-sm mandatory" required />
			</div>
			...
			<div class="mb-3 ">
				...
				<input type="text" id="txt-phone-number" name="txt-phone-number" class="form-control form-control-sm mandatory" required />
			</div>
		...
		<div class="col col-sm-6">
			<div class="mb-3 ">
				...
				echo form_dropdown('opt-user-level', $opt,'', $attributes);
				?>
			</div>
			<!-- <div class="mb-3 ">
				...
				echo form_dropdown('txt-supervisor-name', $spv_list,'', $attributes);
				?>
			</div> -->
			...
			<div class="mb-3 ">
				...
				<div class="input-group input-group-sm has-validation  date" id="datepicker">
					...
					<input type="text" class="form-control form-control-sm mandatory" id="join_date" name="join_date" value="<?php echo date('Y-m-d');?>"/>
				</div>

        ...
        <div class="col col-sm-12">
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-holiday-name" name="txt-holiday-name"
                    class="form-control form-control-sm mandatory" required value="<?= $data['holiday_name']; ?>" />
            </div>
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-holiday-date" name="txt-holiday-date"
                    class="form-control form-control-sm mandatory" required value="<?= $data['holiday_date']; ?>" />
            </div>
            <div class="mb-3 ">

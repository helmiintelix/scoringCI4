...
<div class="card">
    ...
    <div class="card-header">
        Parameter Pengajuan Restructure
    </div>

    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridPpr" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/parameter_pengajuan_restructure/js/restructure_parameter.js?v=<?= rand() ?>">
</script>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-9 p-0" id="multiple_contract2" name="multiple_contract2">
            <!--Contract Detail2-->
        </div>
        <div class="card col-3">
            ...
            <div class="card-body" style="font-size: 10px;">
                <span style="font-weight: bold;float:left;">
                    Total OS Rp. <span id="total_outstanding"></span>
                </span><br />
                <span style="font-weight: bold;float:left;">
                    Aging Obligor <span id="ageing_obligor"><?=@$ageing_obligor ?></span>
                </span><br />
                <span style="font-weight: bold;float:left;">
                </span><br />
                <span style="font-weight: bold;float:left;">
                    Team Leader Id : <span><?=$TL ?></span>
                </span><br />
            </div>
            <hr>
            <div>
                ...
                <div class="container" style="background-color: ; color: black; max-height: 600px; overflow-y: auto;">
                    <form class="form-horizontal" role="form" id="formCallMenu">
                        ...
                        <div class="row mb-2">
                            <?php
                                if(count($lov1)>0){
                                    $lov1 = array(''=>'[select data]')+$lov1;
                            ?>
                            <label class="form-label fs-6" id="lbllov1"
                                for="lov1"><small><?=$lov1_detail['label'];?> :</small></label>
                            <div class="col-sm-12">
                                <?
                                        $attributes = 'class="form-select mandatory" id="lov1"';
                        ...
                        <div class="row mb-2">
                            <?php
                                if(count($lov2)>0){
                                    $lov2 = array(''=>'[select data]')+$lov2;
                            ?>
                            <label class="form-label fs-6" id="lbllov2"
                                for="lov2"><small><?=$lov2_detail['label'];?> :</small></label>
                            <div class="col-sm-12">
                                <?
                                    $attributes = 'class="form-select mandatory" id="lov2"';
                        ...
                        <div class="row mb-2">
                            <?php
                                if(count($lov3)>0){
                                    $lov3 = array(''=>'[select data]')+$lov3;
                            ?>
                            <label class="form-label fs-6" id="lbllov3"
                                for="lov3"><small><?=$lov3_detail['label'];?> :</small></label>
                            <div class="col-sm-12">
                                <?
                                    $attributes = 'class="form-select mandatory" id="lov3"';
                        ...
                        <div class="row mb-2">
                            <?php
                                if(count($lov4)>0){
                                    $lov4 = array(''=>'[select data]')+$lov4;
                            ?>
                            <label class="form-label fs-6" id="lbllov4"
                                for="lov4"><small><?=$lov4_detail['label'];?> :</small></label>
                            <div class="col-sm-12">
                                <?
                                    $attributes = 'class="form-select mandatory" id="lov4"';
                        ...
                        <div class="row mb-2">
                            <?php
                                if(count($lov5)>0){
                                    $lov5 = array(''=>'[select data]')+$lov5;
                            ?>
                            <label class="form-label fs-6" id="lbllov5"
                                for="lov5"><small><?=$lov5_detail['label'];?> :</small></label>
                            <div class="col-sm-12">
                                <?
                                    $attributes = 'class="form-select mandatory" id="lov5"';
                        ...
                        <div class="row mb-2">
                            <label class="form-label fs-6" for="select_join_program"><small>JOIN PROGRAM
                                    :</small></label>
                            <div class="col-sm-12">
                                <?php
                                    $attributes = 'class="form-select mandatory custom-width" id="select_join_program"';
                                    echo form_dropdown('select_join_program', $join_program, "", $attributes);
                                ?>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <label class="form-label fs-6"><small>REQ. PHONE TAG :</small></label>
                            <div class="col-sm-12">
                                <?php
                        ...
                        <div class="row mb-2">
                            <label class="form-label fs-6"><small>REASON PHONE TAG :</small></label>
                            <div class="col-sm-12">
                                <?php
                        ...
                        <div class="row mb-2">
                            <label class="control-label fs-6" for="txt_agent_notepad_not_connected"><small>HOT NOTE :</small></label>
                            <div class="col-sm-12">
                                <textarea class="form-control" id="txt_hot_note" name="txt_hot_note" maxlength="150"
                                    style="height: 30px;"><?=$hot_notes;?></textarea>
                            </div>
                        </div>
                        <div class="row mb-2">
                            <label class="control-label fs-6" for="txt_agent_notepad"><small>NOTE
                                    (max 320
                                    chars)</small><?= $hot_notes; ?></label>
                            <div class="col-sm-12">
                                <textarea class="form-control" id="txt_agent_notepad" name="txt_agent_notepad"
                                    maxlength="320" style="height: 60px;"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-sm-12">
                        ...
                        <div class="row mb-2">
                            <!-- <div class="clearfix form-actions"> -->
                                <div class="col-sm-12">
                                    <!-- <i style="font-size:10px">*talk to TL hanya untuk level group OUTBOUND</i> -->
                                    <div class="text-center">
                                        <!-- <button href="#user_online" class="btn btn-warning btn-sm" data-bs-toggle="collapse" id="btnTalktoTL">Talk to TL</button> -->

...
<div class="card">
    ...
    <div class="card-header">
        DEVIATION REFERENCE SET UP
    </div>

    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridDrsu" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/setup_deviation_reference/js/setup_deviation_reference.js?v=<?= rand() ?>">
</script>
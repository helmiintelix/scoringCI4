        ...
        <div class="col col-sm-12">
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-deviation_reference-deviation_id" name="txt-deviation_reference-deviation_id"
                    class="form-control form-control-sm mandatory" value="<?= $data['deviation_id']; ?>" readonly />
            </div>
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-deviation_reference-deviation_name"
                    ...
                    required value="<?= $data['deviation_name']; ?>" />
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_reference-product[]', $product,  $product, $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_reference-type[]', $options,  $type, $attributes);
				?>
            </div>
            <div class="mb-3 ">
...
<script src="<?= base_url(); ?>modules/setup_deviation_reference/js/setup_deviation_reference_edit.js?v=<?= rand() ?>">
</script>
...
<div class="card">
    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridRpr" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/report_pengajuan_restructure/js/report_pengajuan_restructure.js?v=<?= rand() ?>">
</script>
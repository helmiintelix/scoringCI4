<?php
namespace App\Modules\ReportPengajuanRestructure\models;
use CodeIgniter\Model;

Class Report_pengajuan_restructure_model Extends Model 
{
    function get_report_pengajuan_restructure(){
        $this->builder = $this->db->table('cms_pengajuan_restructure a');

            ...
            <div class="row mb-3">
                    ...
                    <div class="form-group" id="form-checker">
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                ...
                                <!-- <img src="<?=base_url()?>/assets/img/loading.gif" class="pull-right"
                                    id="loading_checker" style="margin-top: 5px;display:none"> -->
                ...
                <div class="col-sm-6" id='form-approval'>
                    <div class="form-group" id="form-approval-1">
                        ...
                        <div class="input-group">
                            <img src="<?=base_url()?>/assets/img/loading.gif" class="pull-right" id="loading_checker"
                            ...
                            <span class="input-group-append">
                                ...
                                <span class="bi bi-plus-square pull-right" id='btn-add-approval-1'
                                    style="cursor:pointer;margin-top: 5px;" onClick="addApproval(this,1)"
                                    data-toggle="tooltip" data-placement="top" title="menambahkan approval"></span>
                                <div class="spinner-border spinner-border-sm" id="loading-approval-1" role="status">
                                    <span class="visually-hidden" id="loading-approval-1">Loading...</span>
                                </div>
                            </span>
                        </div>
                    </div>
...
<script src="<?= base_url(); ?>modules/setup_restructure_approval/js/script_add_form.js?v=<?= rand() ?>">
</script>
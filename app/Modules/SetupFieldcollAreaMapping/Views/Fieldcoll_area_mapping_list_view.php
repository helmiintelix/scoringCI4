...
<div class="card">
    ...
    <div class="card-header">
        FIELD COLL AREA MAPPING
    </div>

    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridFcam" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/setup_fieldcoll_area_mapping/js/setup_fieldcoll_area_mapping.js?v=<?= rand() ?>"></script>
    ...
    <div class="row">
        <div class="col col-sm-12">
            <div class="mb-3">
				...
				echo form_dropdown('txt-collector-name', $collector, $data['collector_id'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('txt-sub_area-name[]', $sub_area, $sub_area_id, $attributes);
				?>
            </div>
            <div class="mb-3 ">
...
<script src="<?= base_url(); ?>modules/setup_fieldcoll_area_mapping/js/script_edit_form.js?v=<?= rand() ?>"></script>
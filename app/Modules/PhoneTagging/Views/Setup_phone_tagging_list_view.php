<div class="row">
    ...
    <div class="col-xs-12">
        <div class="btn-group  btn-group-sm" role="group" aria-label="Basic outlined example">
            <button type="button" class="btn btn-outline-primary" id="btn-approve">Approve</button>
...
<div class="card">
    ...
    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridPtl" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/phone_tagging/js/phone_tagging_list.js?v=<?= rand() ?>"></script>
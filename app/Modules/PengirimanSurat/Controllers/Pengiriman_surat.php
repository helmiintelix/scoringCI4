<?php 
namespace App\Modules\PengirimanSurat\Controllers;
use App\Modules\PengirimanSurat\Models\Pengiriman_surat_model;
use CodeIgniter\Cookie\Cookie;
use DateTime;

class Pengiriman_surat extends \App\Controllers\BaseController
{

	function __construct()
	{
		$this->Pengiriman_surat_model = new Pengiriman_surat_model();
	}
	...
	function index(){
		...
		// dd($data);
		return view('\App\Modules\PengirimanSurat\Views\Report_pengiriman_surat_view', $data);
	}
	function get_report_pengiriman_surat_list(){
		$dataInput['tgl_from'] = '';
		$dataInput['tgl_to'] = '';
		...
		// print_r($dataInput);
		// exit();
		$data = $this->Pengiriman_surat_model->get_report_pengiriman_surat_list($dataInput);
	    if ($data) {
			$cacheKey = session()->get('USER_ID') . '_report_pengiriman_surat_list';

<div class="col-sm-6 mb-3">
    <div class="card">
        ...
        <div class="card-body">
            <form>
                <div class="mb-3">
                    <label for="date-range-picker" class="form-label">Assignment start date - Assignment end date </label>
                ...
                <div class="mb-3">
                    <label for="opt-petugas" class="form-label">Agent</label>
                    <?
...
<div class="row mb-3">
    ...
    <div class="col-xs-12">
        <div class="btn-group  btn-group-sm" role="group" aria-label="Basic outlined example">
            ...
            <button type="button" class="btn btn-outline-warning" id="btn-send-email">Send Email</button>
...
<div class="card">
    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridDah" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/download_account_handling/js/download_account_handling.js?v=<?= rand() ?>">
</script>
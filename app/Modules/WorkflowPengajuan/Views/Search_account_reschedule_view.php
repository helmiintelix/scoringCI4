    ...
    <div class="row">
        ...
        <div class="row">
            <div class="input-group input-group-sm mb-3" style="display:none">
                ...
                <input type="hidden" class="form-control bolded" id="txt-card-number" aria-describedby="basic-addon2">
            </div>
            <div class="input-group input-group-sm mb-3" style="display:none">
    ...
    jQuery(function ($) {
        ...
        function SearchAccount(keyword) {
            ...
            var url = GLOBAL_MAIN_VARS["SITE_URL"] +
                "workflow_pengajuan/workflow_pengajuan_reschedule/search_account";
            $.ajax({
                type: "GET",
                url: url,
                async: false,

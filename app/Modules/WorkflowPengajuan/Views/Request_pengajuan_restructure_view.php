		...
		<div class="col-sm-12" style="margin-top: 10px;">
			<div class="col-sm-6">
				<div class="input-group mb-1">
					...
					<select class="form-control" name='flag_deviation' id='flag_deviation'>
				...
				<div class="input-group mb-1">
					...
					<?
								...
								echo form_dropdown('txt_deviation_reason', $deviation_reason, "", $attributes);
							?>
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt_ptp_date_for_rst" id="txt_ptp_date_for_rst"
						value="<?php if(isset($data_pengajuan['ptp_date'])) echo $data_pengajuan['ptp_date']; else echo date('Y-m-d') ;?>">
				</div>
			</div>
			<div class="col-sm-6">
			...
			<div class="" id='kotak_merah'>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-principle-balance" id="txt-principle-balance"
						value="<?php if(isset($data_pengajuan['principle_balance'])) echo number_format($data_pengajuan['principle_balance']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-principle-balance-val"
						id="txt-principle-balance-val"
						value="<?php if(isset($data_pengajuan['principle_balance'])) echo $data_pengajuan['principle_balance']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-total-due-balance-installment"
						...
						value="<?php if(isset($data_pengajuan['total_due_balance_installment'])) echo number_format($data_pengajuan['total_due_balance_installment']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-total-due-balance-installment-val"
						id="txt-total-due-balance-installment-val"
						value="<?php if(isset($data_pengajuan['total_due_balance_installment'])) echo $data_pengajuan['total_due_balance_installment']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-due-interest" id="txt-due-interest"
						value="<?php if(isset($data_pengajuan['due_interest'])) echo number_format($data_pengajuan['due_interest']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-due-interest-val" id="txt-due-interest-val"
						value="<?php if(isset($data_pengajuan['due_interest'])) echo $data_pengajuan['due_interest']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-late-charge" id="txt-late-charge"
						value="<?php if(isset($data_pengajuan['late_charge'])) echo number_format($data_pengajuan['late_charge']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-late-charge-val" id="txt-late-charge-val"
						value="<?php if(isset($data_pengajuan['late_charge'])) echo $data_pengajuan['late_charge']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-penalty" id="txt-penalty"
						value="<?php if(isset($data_pengajuan['penalty'])) echo number_format($data_pengajuan['penalty']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-penalty-val" id="txt-penalty-val"
						value="<?php if(isset($data_pengajuan['penalty'])) echo $data_pengajuan['penalty']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-stamp-duty" id="txt-stamp-duty"
						value="<?php if(isset($data_pengajuan['stamp_duty'])) echo number_format($data_pengajuan['stamp_duty']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-stamp-duty-val" id="txt-stamp-duty-val"
						value="<?php if(isset($data_pengajuan['stamp_duty'])) echo $data_pengajuan['stamp_duty']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-total" id="txt-total"
						value="<?php if(isset($data_pengajuan['total'])) echo number_format($data_pengajuan['total']); else echo '0' ;?>"
						disabled>
					<input class="form-control" type="hidden" name="txt-total-val" id="txt-total-val"
						value="<?php if(isset($data_pengajuan['total'])) echo $data_pengajuan['total']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-amount-ptp-dp" id="txt-amount-ptp-dp"
						placeholder='0' oninput="countAmountPTP(this)" onblur="validasi2(this)"
						value="<?=@number_format($data_pengajuan['amount_ptp']);?>" />
				</div>
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-payment-bunga" id="txt-payment-bunga"
						placeholder='0' value="<?=@number_format($data_pengajuan['payment_bunga']);?>" disabled>
					<input class="form-control" type="hidden" name="txt-payment-bunga-val" id="txt-payment-bunga-val"
						value="<?php if(isset($data_pengajuan['payment_bunga'])) echo $data_pengajuan['payment_bunga']; else echo '0' ;?>">
				</div>
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-payment-denda" id="txt-payment-denda"
						placeholder='0' value="<?=@number_format($data_pengajuan['payment_denda']);?>" disabled>
					<input class="form-control" type="hidden" name="txt-payment-denda-val" id="txt-payment-denda-val"
						value="<?php if(isset($data_pengajuan['payment_denda'])) echo $data_pengajuan['payment_denda']; else echo '0' ;?>">
				</div>
		...
		<div class="col-sm-6">
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-principle-balance-discount"
					...
					value="<?=@number_format($data_pengajuan['amount_principle_balance_discount']);?>">
				...
				<input type="text" class="form-control" name="txt-principle-balance-discount-2"
					...
					value="<?=@$data_pengajuan['discount_amount_principle_balance'];?>">
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-late-charge-discount" id="txt-late-charge-discount"
					...
					value="<?=@number_format($data_pengajuan['amount_late_charge_discount']);?>">
				<span class="input-group-text">%</span>
				<input type="text" class="form-control" name="txt-late-charge-discount-2"
					...
					placeholder='...' value="<?=@$data_pengajuan['discount_amount_late_charge'];?>">
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-interest-discount" id="txt-interest-discount"
					oninput="currencyformat(this)" onblur="validasi2(this)" placeholder='...' style="width: 150px;"
					value="<?=@number_format(@$data_pengajuan['amount_interest_discount']);?>">
				<span class="input-group-text">%</span>
				<input type="text" class="form-control" name="txt-interest-discount-2" id="txt-interest-discount-2"
					...
					placeholder='...' value="<?=@$data_pengajuan['discount_amount_interest'];?>">
			</div>
			<div class="input-group mb-1" id="div_moratorium" style="display:none">
				...
				<input type="text" class="form-control" value="<?=@$data_pengajuan['moratorium'];?>"
					name="txt-moratorium" id="txt-moratorium" oninput="currencyformat(this)" placeholder=''>
				<input type="hidden" class="form-control" value="<?=@$data_pengajuan['moratorium'];?>"
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-payment-pokok" id="txt-payment-pokok"
					value="<?=@number_format($data_pengajuan['payment_pokok']);?>" disabled>
				<input type="hidden" class="form-control" name="txt-payment-pokok-val" id="txt-payment-pokok-val"
					value="<?=@$data_pengajuan['payment_pokok'];?>" placeholder='0'>
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-sisa-pokok-pinjaman-baru"
					...
					value="<?=@number_format($data_pengajuan['sisa_pokok_pinjaman_baru']);?>" disabled>
				<input type="hidden" class="form-control" name="txt-sisa-pokok-pinjaman-baru-val"
					id="txt-sisa-pokok-pinjaman-baru-val" value="<?=@$data_pengajuan['sisa_pokok_pinjaman_baru'];?>"
					placeholder='0'>
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_tenor_val" id="txt_tenor_val"
					value="<?=@$data_pengajuan['tenor'];?>" oninput="numberOnly(this)">
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_interest_val" id="txt_interest_val"
					value="<?=@$data_pengajuan['interest'];?>" oninput="numberOnly(this)">
			...
			<div class="input-group mb-1">
				...
				<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
					<input type="radio" class="btn-check" value="EFFECTIVE" name="btnradiotipesukubunga" id="btnradio1"
						autocomplete="off" <?php if(@$data_pengajuan['tipe_suku_bunga']=='EFFECTIVE')echo "checked";?>>
					...
					<input type="radio" class="btn-check" value="FLAT" name="btnradiotipesukubunga" id="btnradio2"
						autocomplete="off" <?php if(@$data_pengajuan['tipe_suku_bunga']=='FLAT')echo "checked";?>>
					...
					<input type="radio" class="btn-check" value="SLIDING" name="btnradiotipesukubunga" id="btnradio3"
						autocomplete="off" <?php if(@$data_pengajuan['tipe_suku_bunga']=='SLIDING')echo "checked";?>>
			...
			<div class="input-group mb-1">
				...
				<a href="#" onClick="jadwal_pebayaran()">view</a>
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_new_installment_amount"
					id="txt_new_installment_amount" value='<?=@number_format($data_pengajuan['new_installment']);?>'
					disabled>
				<input type="hidden" class="form-control" name="txt_new_installment_amount_val"
					id="txt_new_installment_amount_val" value='<?=@$data_pengajuan['new_installment'];?>' />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-12" style=" margin-top: 30px;">
			<center>Remark<br><textarea cols="100" rows="5" name='txt-remark'><?=@$data_pengajuan['notes'];?></textarea>
			</center>
		</div>
	</div>
	...
	<div class="col-sm-12">
		...
		<div class="row">
			...
			<div id="call-verif-process" class="col-sm-6"
				<?php if(@$data_pengajuan['status']=='NEW' || $screen_level=='NEW'){ echo 'style="display:none"';} ?>>
				<!-- start col-sm-6 -->

				<!-- <h4 class="">Verifikasi By Call  <?php if(in_array(@$data_pengajuan['call_verification_status'],array('FINISH','DRAFT'))){echo "[".@$data_pengajuan['call_verification_status']."]";}?> </h4> -->
				<h4 class="">Verifikasi By Call </h4>
				<i style="font-size: 12px;display:none;color:red" id="alert_verif_call">*anda telah menyelesaikan
					verification By Call</i>
				<div class="profile-user-info profile-user-info-striped" style="padding: 15px;">
					<div class="profile-info-row" style="margin-bottom: 20px;">
						...
						<label for="mother_handphone">Mother Handphone :
							<?=$customer_data['mother_handphone']?></label><br>

						<input type="radio" name="phone-owner" id="office_phone"
							value="<?=$customer_data['office_phone']?>" />
						<label for="office_phone">Office Phone : <?=$customer_data['office_phone']?></label><br>

						<!--  -->
						<input type="radio" name="phone-owner" id="spouse_phone"
							value="<?=$customer_data['spouse_phone']?>" />
						...
						<button type="button" id='btn-to-call'
							class="btn btn-success btn-sm pull-right btn-form-call"><span
					...
					<div class="profile-info-row" style="margin-top: 10px;height: 35px;">
						<button class='btn btn-warning btn-sm pull-right btn-form-call'
							onClick='save_call_history("FINISH")'
							<?php if(@$data_pengajuan['call_verification_status']=='FINISH'){echo "disabled";}?>>save</button>
						<!-- <button class='btn btn-warning btn-sm  pull-right btn-form-call' style='margin-right:5px' onClick='save_call_history("DRAFT")' <?php if(@$data_pengajuan['call_verification_status']=='FINISH'){echo "disabled";}?>>save</button> -->
						<!-- <button class='btn btn-danger btn-sm btn-form-call'>cancel</button> -->
						<!-- <img src="<?=base_url()?>/assets/img/loading.gif" id="loading_call"
							style="margin-left: 55%;display:none"> -->
			...
			<div class="col-sm-6">
				...
				<form role="form" class="needs-validation" id="form_upload_doc" name="form_upload_doc" novalidate>
					<!-- <h4 class="">Upload Document <?php if(in_array(@$data_pengajuan['document_upload_status'],array('FINISH','DRAFT'))){echo "[".@$data_pengajuan['document_upload_status']."]";}?> </h4> -->
					<h4 class="">Upload Document </h4>

					<?php
						foreach ($master_document as $key => $value) {
						
						$jumlah = $this->Common_model->get_record_value('count(*)','cms_upload_document','id_pengajuan="'.@$data_pengajuan['id'].'" and id_upload="'.$value['id'].'" ');
						$jumlah_other = $this->Common_model->get_record_value('count(*)','cms_upload_document','id_pengajuan="'.@$data_pengajuan['id'].'" and id_upload="other" ');
					?>
					<div class="input-group mb-1">

						<span class="input-group-text widthLabel"
							id="basic-addon2"><?php if($value['is_mandatory']=='Y') echo "*";?>
							<?=$value['nama_document']?> (<span
								id="jumlah-uploaded-<?=$value['id']?>"><?=$jumlah;?></span>) </span>
						<input type='file' class='form-control doUpload' accept="" data-label='<?=$value['id']?>'
							name='<?=$value['id']?>' id='<?=$value['id']?>' style="max-width: 230px;"
							<?php if($value['is_mandatory']=='Y' && $jumlah == 0) echo "required";?>>
					</div>
					<div class="progress" role="progressbar" aria-label="Success example" style="display:none"
						aria-valuenow="25" id='div-progress-bar-<?=$value['id']?>' aria-valuemin="0"
						aria-valuemax="100">
						<div class="progress-bar bg-success" id="progress-bar-<?=$value['id']?>" style="width: 0%">
							<i><?=$value['nama_document']?> uploading...</i></div>
					</div>
					<?php
						}
					?>
					<div class="input-group mb-1">
						<span class="input-group-text widthLabel" id="basic-addon2">Other file (<span
								id="jumlah-uploaded-other"><?=$jumlah;?></span>) </span>
						<input type='file' class='form-control doUpload' accept="" data-label='other' name='other'
							id='other' style="max-width: 230px;" />
					</div>
					<div class="progress" role="progressbar" aria-label="Success example" style="display:none"
						aria-valuenow="25" id='div-progress-bar-other' aria-valuemin="0" aria-valuemax="100">
						<div class="progress-bar bg-success" id="progress-bar-other" style="width: 0%"><i>other
								uploading...</i></div>
					</div>
					<div class="input-group mb-1">
						<span class="input-group-text widthLabel" id="basic-addon2">Other info</span>
						<input type='text' class='form-control' accept="" data-label='file-other-doc-info'
							name='file-other-doc-info' id='file-other-doc-info' style="max-width: 230px;" />
					</div>
					<div class="input-group mb-1">
						<span class="input-group-text widthLabel" id="basic-addon2">Remark</span>
						<textarea class="form-control" cols="45" rows="3" name='upload-data-remark'
							id='upload-data-remark'></textarea>
					</div>
...
<script type="text/javascript">
	var STATUS_DOC = '<?=@$data_pengajuan['document_upload_status ']?>';
	var tipe_suku_bunga = '';
...
<script src="<?= base_url(); ?>modules/workflow_pengajuan/js/request_pengajuan_restructure.js?v=<?= rand() ?>"></script>
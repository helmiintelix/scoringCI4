			...
			<div class="col-sm-6">
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="is_deviation" id="is_deviation"
						value="<?php if($pengajuan_data['deviation_flag']=='1') {echo "yes"; }else{ echo "no";} ?>"
						readonly>
				</div>
				<div class="input-group mb-1">
					<span class="input-group-text widthLabel" id="txt_deviation_reason"> Deviation Reason</span>
					<?php
						$attributes = 'class="form-control" id="txt_deviation_reason" style="display:block;max-width:200px" disabled';
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt_ptp_date_for_rst" id="txt_ptp_date_for_rst"
						value="<?=$pengajuan_data['ptp_date']?>" readonly>
				</div>
			</div>
			<div class="col-sm-6">
			...
			<div class="" id='kotak_merah'>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-principle-balance" id="txt-principle-balance"
						value='<?=number_format($pengajuan_data['principle_balance'],2)?>' disabled>
					<input class="form-control" type="hidden" name="txt-principle-balance-val"
						id="txt-principle-balance-val" value='<?=$pengajuan_data['principle_balance']?>'>
				</div>
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-total-due-balance-installment"
						...
						value='<?=number_format($pengajuan_data['total_due_balance_installment'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-due-interest" id="txt-due-interest"
						value='<?=number_format($pengajuan_data['due_interest'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-late-charge" id="txt-late-charge"
						value='<?=number_format($pengajuan_data['late_charge'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-penalty" id="txt-penalty"
						value='<?=number_format($pengajuan_data['penalty'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-stamp-duty" id="txt-stamp-duty"
						value='<?=number_format($pengajuan_data['stamp_duty'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input class="form-control" type="text" name="txt-total" id="txt-total"
						value='<?=number_format($pengajuan_data['total'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-amount-ptp-dp" id="txt-amount-ptp-dp"
						placeholder='0' value='<?=number_format($pengajuan_data['amount_ptp'],2)?>' readonly>
				</div>
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-payment-bunga" id="txt-payment-bunga"
						placeholder='0' value='<?=number_format($pengajuan_data['payment_bunga'],2)?>' disabled>
				...
				<div class="input-group mb-1">
					...
					<input type="text" class="form-control" name="txt-payment-denda" id="txt-payment-denda"
						placeholder='0' value='<?=number_format($pengajuan_data['payment_denda'],2)?>' disabled>
		...
		<div class="col-sm-6">
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-principle-balance-discount"
					...
					value='<?=number_format($pengajuan_data['amount_principle_balance_discount'],2)?>' readonly />
				...
				<input type="text" class="form-control" name="txt-principle-balance-discount-2"
					...
					value='<?=number_format($pengajuan_data['discount_amount_principle_balance'],2)?>' readonly />
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-late-charge-discount" id="txt-late-charge-discount"
					...
					value='<?=number_format($pengajuan_data['amount_late_charge_discount'],2)?>' readonly />
				<span class="input-group-text">%</span>
				<input type="text" class="form-control" name="txt-late-charge-discount-2"
					...
					value='<?=number_format($pengajuan_data['discount_amount_late_charge'],2)?>' placeholder='...'
					readonly />
			</div>
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-interest-discount" id="txt-interest-discount"
					oninput="currencyformat(this)" onblur="validasi2(this)" placeholder='...' style="width: 150px;"
					value='<?=number_format($pengajuan_data['amount_interest_discount'],2)?>' readonly />
				<span class="input-group-text">%</span>
				<input type="text" class="form-control" name="txt-interest-discount-2" id="txt-interest-discount-2"
					...
					value='<?=number_format($pengajuan_data['discount_amount_interest'],2)?>' placeholder='...'
					readonly />
			</div>
			<div class="input-group mb-1" id="div_moratorium" style="display:none">
				...
				<input type="text" class="form-control" name="txt-moratorium" id="txt-moratorium"
					oninput="currencyformat(this)" value='<?=number_format($pengajuan_data['moratorium'],2)?>'
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-payment-pokok-val" id="txt-payment-pokok-val"
					value='<?=number_format($pengajuan_data['payment_pokok'],2)?>' disabled>
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt-sisa-pokok-pinjaman-baru"
					...
					value='<?=number_format($pengajuan_data['sisa_pokok_pinjaman_baru'],2)?>' disabled>
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_tenor_val" id="txt_tenor_val"
					oninput="numberOnly(this)" value='<?=$pengajuan_data['tenor']?>' readonly>
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_interest_val" id="txt_interest_val"
					oninput="numberOnly(this)" value='<?=number_format($pengajuan_data['interest'],2)?>' readonly>
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_tipe_suku_bunga" id="txt_tipe_suku_bunga"
					oninput="numberOnly(this)" value='<?=$pengajuan_data['tipe_suku_bunga']?>' readonly>
			</div>
			<div class="input-group mb-1">
			...
			<div class="input-group mb-1">
				...
				<input type="text" class="form-control" name="txt_new_installment_amount"
					id="txt_new_installment_amount" value='<?=number_format($pengajuan_data['new_installment'],2)?>'
					disabled>
	...
	<div class="row">
		<div class="col-sm-12" style=" margin-top: 30px;">
			<center>Remark<br><textarea cols="100" rows="5" name='txt-remark'
					readonly><?=$pengajuan_data['notes']?></textarea></center>
		</div>
	</div>
					...
					<?php
						...
						foreach ($history_call as $key => $value) {
							echo "<tr>";
								...
								if($value['caller_id']!=''){
									echo "<td><a href='#' onclick='playRecording(\"".$value['caller_id']."\")' > play</a></td>";
								}else{
									echo "<td><i>[EMPTY]</i></a>";
								}
							echo "</tr>";
...
<div class="row">
	<div class="col-sm-6">
		...
		<div class="list-group">
			<?php
				$is_active = 'active';
				$is_able_to_approve = '0';
					foreach ($verif_data as $key => $value) {
						if( $value['level_num']==@$APPROVAL_LEVEL && !in_array($pengajuan_data['status'],array('APPROVE','REJECT'))){
						...
						foreach ($value['list_approval'] as $keyx => $valuex) {
							...
							$builder->select('*');
							$builder->where('id_pengajuan', $pengajuan_data['id']);
							...
							// $res = $this->db->query($sql,array($pengajuan_data['id'],$valuex['user_id'],$value['level_num']))->result_array();
							$command='';
	...
	<!-- $view adalah param yg di lempar dari menu report pengajuan reschedule , jika di buka dari menu pengajuan reschedule $view bernilai 1 -->
	<div class="col-sm-6" <?php if($view=='1')echo "style='display:none'"; ?>>
		...
		<div class="input-group mb-1">
			...
			<button class='btn btn-success btn-sm pull-right' id="saveApproval" onClick="saveApproval_rsch()"
				style="margin: 10px;"
				<?php if(in_array($pengajuan_data['status'],array('APPROVED','REJECT')))echo "disabled"; ?>>SAVE</button>
...
<script type="text/javascript">
	...
	var last_action = '';
	var is_able_to_approve = "<?=$is_able_to_approve?>";
	...
	function search_param() {
		...
		$.ajax({
			type: "GET",
			url: URL_DATA + "workflow_pengajuan/workflow_pengajuan_reschedule/cek_config_rest",
			data: {
	...
	jQuery(function ($) {
		...
		// if (is_able_to_approve == '0') {
		// 	$("#saveApproval").attr('disabled', true).html('<i>not approval</i>');
	...
	function get_data_perhitungan_kotak_merah() {
		...
		$.ajax({
			type: "POST",
			url: URL_DATA + "workflow_pengajuan/Workflow_pengajuan_reschedule/get_data_kotak_merah",
			data: {
				due_date: due_date,
	...
	function save($flag) {
		...
		$('#loading_save').show();
		$.ajax({
			url: URL_DATA + "workflow_pengajuan/workflow_pengajuan_reschedule/save_pengajuan_reschedule?status=" +
				$flag,
			type: "post",
			...
			success: function (msg) {
				...
				if (msg.success) {
					...
					try {
						update_join_program('RESCHEDULE'); //fungsi ada di panin_deskcoll agent_main.js
					} catch (error) {
						console.log(error);
					}
	...
	function get_new_installment_amount(sisapokokpinjamanbaru, txt_tenor_val, txt_interest_val) {
		...
		$.ajax({
			...
			async: true,
			dataType: "json",
			url: URL_DATA + 'workflow_pengajuan/workflow_pengajuan_reschedule/get_new_installment_amount?tipe=' + tipe + '&tenor=' +
	...
	function show_jadwal_pembayaran() {
		...
		let product_code = "<?=$pengajuan_data['product_code']?>";
		...
		showCommonDialog3(1000, 700, "JADWAL PEMBAYARAN - " + tipe, URL_DATA +
			'workflow_pengajuan/workflow_pengajuan_reschedule/show_payment_plan?id=' + id + "&tipe=" + tipe + "&product_code=" +
			product_code, buttons);
	...
	function save_upload_document(status) {
		...
		$.ajax({
			url: GLOBAL_MAIN_VARS["SITE_URL"] +
				"workflow_pengajuan/workflow_pengajuan_reschedule/save_document_verification?tipe=reschedule",
			data: formdata,
			async: true,
			type: "POST",
			cache: false,
	...
	function get_detail_view(id) {
		...
		showCommonDialog3(1200, 700, 'DETAIL DOCUMENT', GLOBAL_MAIN_VARS["SITE_URL"] +
			'workflow_pengajuan/workflow_pengajuan_reschedule/view_detail_upload/?id=' + id_pengajuan + '&doc=' + id,
			buttons);
	}

	function saveApproval_rsch() {
			...
			.then((willDelete) => {
				if (willDelete) {
					...
					$.ajax({
						type: "POST",
						url: GLOBAL_MAIN_VARS["SITE_URL"] +
							"workflow_pengajuan/workflow_pengajuan_reschedule/saveApprovalberjenjang",
						data: {
							id: id_pengajuan,
							action: action,
							remark: remark,
	...
	function playRecording(callid) {
		...
		$.ajax({
			type: "POST",
			url: GLOBAL_MAIN_VARS["SITE_URL"] + "workflow_pengajuan/workflow_pengajuan_reschedule/getRecording",
			data: {
				id: callid
			},
			async: false,
			...
			success: function (msg) {
				...
				if (msg.success == true) {
					$("#source_recording").attr('src', msg.recording);
					var audio = $("#player_recording");
					audio[0].pause();

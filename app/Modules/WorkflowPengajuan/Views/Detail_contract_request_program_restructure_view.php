...
<form class="form-horizontal" id="formDiscountRequest" name="formDiscountRequest" method="POST">
    <?php 
			$alertPengajuan = '';
			if(@$data_pengajuan["status"]=='REJECT'){
				$rejector = $this->Common_model->get_record_values('b.name,a.notes','cms_approval a,cc_user b','a.created_by=b.id and a.id_pengajuan="'.$data_pengajuan["id"].'"  and a.action="APPROVAL" ');
				$jam = $this->Common_model->MonthIndo($data_pengajuan["updated_time"]);
			...
			else if(@$data_pengajuan["status"]=='APPROVE'){
				$rejector = $this->Common_model->get_record_value('b.name','cms_approval a,cc_user b','a.created_by=b.id and a.id_pengajuan="'.$data_pengajuan["id"].'" and a.action="APPROVAL" ');
				$jam = $this->Common_model->MonthIndo($data_pengajuan["updated_time"]);
    ...
    <div class="row">
        <div class="col-sm-6">
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-cif" value="<?=$credit_data["CM_CUSTOMER_NMBR"]?>"
                    aria-describedby="basic-addon2" disabled>
            </div>
            <div class="input-group mb-1">
                <span class="input-group-text widthLabel" id="basic-addon2">Customer Name</span>
                <input type="text" class="form-control" value="&nbsp;<?=$credit_data["CR_NAME_1"]?>"
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-outstanding-ar"
                    value="<?=number_format(@$credit_data["CM_TOTAL_OS_AR"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-outstanding-principal"
                    value="<?=number_format(@$credit_data["CM_OS_PRINCIPLE"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-outstanding-interest"
                    value="<?=number_format(@$credit_data["CM_OS_INTEREST"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-installment"
                    value="<?=number_format(@$credit_data["CM_INSTALLMENT_AMOUNT"]??0,2)?>"
                    aria-describedby="basic-addon2" disabled>
            </div>
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="txt_os_balance"
                    value="<?=number_format($credit_data["CM_OS_BALANCE"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-principal-balance"
                    value="<?=number_format($credit_data["CM_TOT_PRINCIPAL"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-due-interest"
                    value="<?=number_format($credit_data["CM_TOT_INTEREST"]??0,2)?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
        ...
        <div class="col-sm-6">
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-mob-open-date"
                    value="<?=$credit_data["MOB"]?>/<?echo $this->Common_model->MonthIndo($credit_data["CM_DTE_OPENED"]);?>" aria-describedby="basic-addon2" disabled>
            </div>
            <div class="input-group mb-1">
                <span class="input-group-text widthLabel" id="basic-addon2"> Installment No./Tenor</span>
                <input type="text" class="form-control" id="lbl-mob-open-date"
                    value="<?=$credit_data["CM_INSTALLMENT_NO"]?>/<?=$credit_data["CM_TENOR"]?>"
                    aria-describedby="basic-addon2" disabled>
            </div>
            <div class="input-group mb-1">
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-mob-open-date"
                    value="<?=$credit_data["PRODUCT_ID"]?>/<?=$credit_data["CM_PRODUCT_TYPE"]?>" aria-describedby="basic-addon2"
                    disabled>
            </div>
            <div class="input-group mb-1">
            ...
            <div class="input-group mb-1">
                ...
                <input type="text" class="form-control" id="lbl-request-by" value="<?=@$pengajuan_data["AGENT_ID"]?>"
                    aria-describedby="basic-addon2" disabled>
            </div>
            <div class="input-group mb-1">

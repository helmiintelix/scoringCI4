        ...
        <div class="col col-sm-12">
            ...
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-agency-province', $province,'', $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-agency-city', $options, "", $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-agency-district', $options, "", $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-agency-sub-district', $options, "", $attributes);
				?>
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-am-coordinator', $arco_id,'', $attributes);
				?>
            </div>
        </div>
    </div>
...
<script src="<?= base_url(); ?>modules/agency_management/js/script_add_form.js?v=<?= rand() ?>"></script>
        ...
        <div class="col col-sm-12">
            ...
            <div class="mb-3">
                <textarea maxlength="50" class="form-control form-control-sm mandatory" name="txt-template-content"
                    id="txt-template-content" style="height: 300px;"></textarea>
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3 ">
				...
				echo form_dropdown('opt-sentby', $options, '', $attributes);
				?>
            </div>
            <div class="mb-3" id="div-template-relation">
				...
				echo form_dropdown('opt-template-relation', $options, '', $attributes);
				?>
            </div>
            ...
            <div class="mb-3" id="div-recepient">
				...
				echo form_dropdown('opt-recipient', $options, '', $attributes);
				?>
            </div>
            <div class="mb-3" id="rules_ptp">
				...
				echo form_dropdown('opt-rules[]', $options, '', $attributes);
				?>
            </div>
            <div class="mb-3" id="rules_billing_info">
                <label for="opt-rules_billing" class="fs-6 text-capitalize">Rules</label>
                <?php
				$options = array(
                    "Before Due Date" => "Before Due Date",
                    "After Due Date" => "After Due Date"
				);
				$attributes = 'class="chosen-select form-control form-control-sm mandatory" id="opt-rules_billing" name="opt-rules_billing[]"  multiple data-placeholder="-Please Select Product-"';
				echo form_dropdown('opt-rules_billing[]', $options, '', $attributes);
				?>
            </div>
            ...
            <div class="mb-3 hide" id="div-mechanism">
                ...
                echo form_dropdown('opt-schedule', $options, '', $attributes);
                ?>
                &nbsp;
                &nbsp;
                &nbsp;
...
<script src="<?= base_url(); ?>modules/email_sms_template/js/script_add_form.js?v=<?= rand() ?>"></script>
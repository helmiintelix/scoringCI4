	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3 ">
				...
				<input type="text" id="txt_wa_child_name" name="txt_wa_child_name" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3">
            ...
            <div class="mb-3 ">
				...
				<input type="text" id="txt_wa_label_name" name="txt_wa_label_name" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3">
                ...
                <div style="display: flex; align-items: center;">
                    <?php
                        ...
                        echo form_dropdown('opt_wa_label_number[]', $list_order, '', $attributes);
                    ?>
            </div>
            <div class="mb-3">
                <label for="txt_wa_template_template_design" class="fs-6 text-capitalize">Message</label>
                <textarea id="txt_wa_template_template_design" name="txt_wa_template_template_design" class="form-control form-control-sm mandatory" rows="4" placeholder="pakai {{1}} dan seterusnya untuk menggunakan parameter" required></textarea>
            </div>
			<div class="mb-3">
...
<script src="<?= base_url(); ?>modules/setup_wa_flow/js/setup_wa_flow_add.js?v=<?= rand() ?>"></script>
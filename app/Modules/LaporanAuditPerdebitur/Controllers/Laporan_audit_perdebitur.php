<?php 
namespace App\Modules\LaporanAuditPerdebitur\Controllers;
use App\Modules\LaporanAuditPerdebitur\Models\Laporan_audit_perdebitur_model;
use CodeIgniter\Cookie\Cookie;

class Laporan_audit_perdebitur extends \App\Controllers\BaseController
{

	function __construct()
	{
		$this->Laporan_audit_perdebitur_model = new Laporan_audit_perdebitur_model();
	}
	...
	function index(){
		...
		// dd($data);
		return view('\App\Modules\LaporanAuditPerdebitur\Views\Report_audit_perdebitur_view', $data);
	}
	function get_report_audit_perdebitur(){
		$loan_number = $this->input->getGet('loan_number');
		$data = $this->Laporan_audit_perdebitur_model->get_report_audit_perdebitur_list($loan_number);
	    if ($data) {
			$cacheKey = session()->get('USER_ID') . '_report_janji_bayar_list';

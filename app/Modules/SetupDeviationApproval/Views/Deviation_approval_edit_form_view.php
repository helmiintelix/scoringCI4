<form role="form" class="needs-validation" id="form_add" name="form_add" novalidate>
    ...
    <input type="hidden" name="txt-id" id="txt-id" value="<?= $data['id']; ?>">
    <div class="row">
        <div class="col col-sm-12">
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-deviation_approval-dev_app_id" name="txt-deviation_approval-dev_app_id"
                    class="form-control form-control-sm mandatory" required value="<?= $data['dev_app_id']; ?>" />
            </div>
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-deviation_approval-dev_app_name" name="txt-deviation_approval-dev_app_name"
                    class="form-control form-control-sm mandatory" required value="<?= $data['dev_app_name']; ?>" />
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-dev_ref_id[]', $deviation_reference,  $dev_ref, $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_1_user_1', $userlist,  $data['app_1_user_1'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_1_user_2', $userlist,  $data['app_1_user_2'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_1_user_3', $userlist,  $data['app_1_user_3'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_2_user_1', $userlist,  $data['app_2_user_1'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_2_user_2', $userlist, $data['app_2_user_2'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_2_user_3', $userlist,  $data['app_2_user_3'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_3_user_1', $userlist,  $data['app_3_user_1'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_3_user_2', $userlist,  $data['app_3_user_2'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_3_user_3', $userlist, $data['app_3_user_3'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_4_user_1', $userlist,  $data['app_4_user_1'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_4_user_2', $userlist,  $data['app_4_user_2'], $attributes);
				?>
            </div>
            <div class="mb-3 ">
                <?php
                    ...
                    echo form_dropdown('opt-deviation_approval-app_4_user_3', $userlist,  $data['app_4_user_3'], $attributes);
				?>
            </div>
        </div>
    </div>
</form>
<script src="<?= base_url(); ?>modules/setup_deviation_approval/js/setup_deviation_approval_edit.js?v=<?= rand() ?>">
</script>
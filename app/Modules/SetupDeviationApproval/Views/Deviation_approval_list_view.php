...
<div class="card">
    ...
    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridDrau" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/setup_deviation_approval/js/setup_deviation_approval.js?v=<?= rand() ?>">
</script>
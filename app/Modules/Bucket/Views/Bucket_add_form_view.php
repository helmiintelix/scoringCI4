        ...
        <div class="col col-sm-12">
            ...
            <div class="mb-3 ">
                ...
                <? foreach ($product as $value) {
                    ...
                    echo form_dropdown('product[]', $data,"", $attributes);
                ?>
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3 ">
				...
				echo form_dropdown('amount_to_be_paid_to_keep_promise', $options, '', $attributes);
				?>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 ">
				...
				echo form_dropdown('min_amount_acceptable_promise', $options, '', $attributes);
				?>
            </div>
            <div class="mb-3">
...
<script src="<?= base_url(); ?>modules/bucket/js/script_add_form.js?v=<?= rand() ?>"></script>
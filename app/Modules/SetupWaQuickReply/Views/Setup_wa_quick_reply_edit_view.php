	...
	<div class="row">
		<div class="col col-sm-12">
			...
			<div class="mb-3">
                ...
                <textarea id="txt_wa_template_template_design" name="txt_wa_template_template_design" class="form-control form-control-sm mandatory"  rows="4" required><?= $data_template['message']?></textarea>
            </div>
            <div class="mb-3 ">
				...
				<div style="display: flex; align-items: center;">
                    <?php
                        ...
                        echo form_dropdown('list_group[]', $list_group, $group_list_selected, $attributes);
                    ?>
                </div>
			</div>
			<div class="mb-3 ">
				...
				<div class="form-check form-switch">
					...
					<input onChange="isActive(this)" class="form-check-input" type="checkbox" role="switch"
                        ...
                        <?php echo $data_template["is_active"]=='Y'?  'checked' :  ''; ?>>
				</div>
			</div>
...
<script src="<?= base_url(); ?>modules/setup_wa_quick_reply/js/setup_wa_quick_reply_edit.js?v=<?= rand() ?>"></script>
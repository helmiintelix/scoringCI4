...
<form role="form" class="needs-validation" id="form_add" name="form_add" novalidate>
    <? 
    // $jsonAG = json_encode($account_group ?: []); 
    ?>
        ...
        <div class="col col-sm-12">
            ...
            <div class="mb-3 ">
                ...
                <input type="text" id="txt-classification-priority" name="txt-classification-priority"
                    class="form-control form-control-sm mandatory" required /> (* higher number less priority)
            </div>
            <div class="mb-3 ">
                ...
                <?php
                     $options = array(
                        ...
                        echo form_dropdown('opt-handling[]', $options,  "Telecoll", $attributes);
                        ?>
            </div>
            <div class="mb-3" style="display: none;">
                ...
                <?php
                    ...
                    echo form_dropdown('check-number', $options,  "0", $attributes);
                ?>
            </div>
            <div class="mb-3" id="form-template-sms">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-sms-template', $options,  "", $attributes);
                ?>
            </div>
            <div class="mb-3" id="form-template-email">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-email-template', $options,  "", $attributes);
                ?>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-4">
                        <?php
                            ...
                            echo form_dropdown('opt-schedule', $schedule, 'DAILY', $attributes);
                        ?>
                    </div>
            ...
            <div class="mb-3 ">
                ...
                <input type="text" id="effectiveDate" name="effectiveDate"
                    class="form-control form-control-sm mandatory" value="" />
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3">
                ...
                <?php
                    ...
                    echo form_dropdown('opt-allocation-type', $allocation_type,  "TEMPORER", $attributes);
                ?>
            </div>
            <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-5">
                        <?php
                            ...
                            echo form_dropdown('opt-assignment_duration', $opt_assignment_duration,  "", $attributes);
                        ?>

...
<div class="card">
    ...
    <div class="card-header">
        Visit Radius Geofencing Maker
    </div>

    <div class="card-body">
        <div class="col-xs-12" id="parent">
            <div id="myGridVrgm" style="height: 450px;" class="ag-theme-alpine"></div>
        </div>
    </div>
</div>
...
<script src="<?= base_url(); ?>modules/visit_radius/js/visit_radius.js?v=<?= rand() ?>"></script>
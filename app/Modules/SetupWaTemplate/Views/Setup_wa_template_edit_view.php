	...
	<div class="row">
		<div class="col col-sm-12">
			<div class="mb-3 ">
				...
				<input value="<?= $data_template['template_id']?>" type="text" id="txt_wa_template_template_id" name="txt_wa_template_template_id" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				<label for="form-field-select-2" class="fs-6 text-capitalize">TEMPLATE NAME </label>
				<input value="<?= $data_template['template_name']?>" type="text" id="txt_wa_template_template_name" name="txt_wa_template_template_name" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 ">
				<label for="txt-template-input-times1" class="fs-6 text-capitalize">SEND TIME </label>
				<input value="<?= $data_template['select_time']?>" style="width: 20%;" type="time" id="txt-template-input-times1" name="txt-template-input-times1" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3">
			...
			<div class="mb-3">
                ...
                <textarea id="txt_wa_template_template_design" name="txt_wa_template_template_design" class="form-control form-control-sm mandatory" readonly rows="4" required><?= $data_template['template_design']?></textarea>
            </div>
            
			<div class="mb-3 ">
				<label for="txt_wa_max_retry" class="fs-6 text-capitalize"> MAX RETRY </label>
				<input value="<?= $data_template['max_retry']?>" type="text" id="txt_wa_max_retry" name="txt_wa_max_retry" class="form-control form-control-sm mandatory" required/>
			</div>
			<div class="mb-3 "></div>
			<div class="mb-3 ">
				...
				<div class="form-check form-switch">
					...
					<input onChange="isActive(this)" class="form-check-input" type="checkbox" role="switch"
                        ...
                        <?php echo $data_template["is_active"]=='1'?  'checked' :  ''; ?>>
				</div>
			</div>
...
<script src="<?= base_url(); ?>modules/setup_wa_template/js/setup_wa_template_edit.js?v=<?= rand() ?>"></script>
...
function getData() {
  $.ajax({
    url:
      ...
      "approval_agent_wa_blast/approval_agent_wa_blast/get_pengiriman_surat_file_list" +
      classification,
    type: "get",
...
$("#btn-upload").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "approval_agent_wa_blast/approval_agent_wa_blast/save_file",
          type: "post",
          dataType: "json",
  ...
  showCommonDialog(
    ...
    "UPLOAD WA BLAST",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "approval_agent_wa_blast/approval_agent_wa_blast/upload_file_form",
    buttons
  );
});
...
$("#btn-view").click(function () {
  if (selr) {
    var buttons = {
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "approval_agent_wa_blast/approval_agent_wa_blast/approve_upload_file",
            type: "post",
            data: {
              id: selr,
            },
      ...
      reject: {
        ...
        callback: function () {
            ...
            var options = {
                url: GLOBAL_MAIN_VARS["SITE_URL"] + "approval_agent_wa_blast/approval_agent_wa_blast/reject_upload_file",
                type: "post",
                data: {
                    id: selr,
                },
    ...
    showCommonDialog(
      ...
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "approval_agent_wa_blast/approval_agent_wa_blast/show_uploaded_file_form?id=" +
        selr,
      buttons
    );
  } else {

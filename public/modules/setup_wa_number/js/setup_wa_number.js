...
function getData() {
  $.ajax({
    url: GLOBAL_MAIN_VARS["SITE_URL"] + "setup_wa_number/setup_wa_number/device_list" +
      classification,
    type: "get",
...
$("#btn-add").click(function () {
  var buttons = {
    "success":
    {
      ...
      "callback": function () {
        var options = {
          url: GLOBAL_MAIN_VARS["SITE_URL"] + "setup_wa_number/setup_wa_number/save_device_add",
          type: "post",
  ...
  showCommonDialog(800, 800, 'ADD SETUP DEVICE', GLOBAL_MAIN_VARS["SITE_URL"] + '/setup_wa_number/setup_wa_number/device_add_form', buttons);
});

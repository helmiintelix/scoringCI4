...
function getData() {
  $.ajax({
    url:
      ...
      "settings/email_sms_template/email_sms_list" +
      classification,
    type: "get",
...
function getDataApproval() {
  $.ajax({
    url:
      GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/email_sms_template_temp/email_sms_list_temp" +
      classification,
    type: "get",
    success: function (msg) {
...
var eGridDiv = document.getElementById("myGridEst");
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/email_sms_template/save_email_sms_add",
          type: "post",
  ...
  showCommonDialog(
    ...
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/email_sms_template/email_sms_add_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/email_sms_template/save_email_sms_edit",
            type: "post",
            success: showFormResponse,
            dataType: "json",
            data: { content: tinyMCE.activeEditor.getContent() },
    ...
    showCommonDialog(
      ...
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "settings/email_sms_template/emailSmsEditForm?id=" +
        selr,
      buttons
    );
  } else {

...
function getData() {
  $.ajax({
    url:
      ...
      "visit_radius/report_visit_radius/get_report_visit_luar_radius" +
      classification,
    type: "get",
...
var eGridDiv = document.getElementById("myGridRivlr");
...
var TrackingAgent = function (lat, long, user_id, id, card, addr_type) {
  // alert(
  ...
  showCommonDialog(
    ...
    "TRACKING",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "visit_radius/report_visit_radius/tracking_history_visit?user_id=" +
      user_id +
      "&id=" +
      id +
      "&card=" +

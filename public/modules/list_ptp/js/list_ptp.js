...
function getData() {
  $.ajax({
    url:
      ...
      "reportCols/load_list_ptp/get_report_janji_bayar_list" +
      classification,
    type: "get",
...
// $("#btn-export-rtf").click(function () {
//   var downloadUrl =
//     GLOBAL_MAIN_VARS["SITE_URL"] +
//     "reportCols/load_list_ptp/get_report_janji_bayar_list?petugas=" +
//     $("#opt-petugas").val() +
//     "&tgl=" +
//     $("#date-range-picker").val();
...
//   link.download = "exported_data.rtf";

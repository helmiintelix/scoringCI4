...
function getData() {
  $.ajax({
    url:
      ...
      "settings/area_tagih/area_tagih_list" +
      classification,
    type: "get",
...
function getDataApproval() {
  $.ajax({
    url:
      GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/area_tagih_temp/area_tagih_list_temp" +
      classification,
    type: "get",
    success: function (msg) {
      var columnDefs = msg.data.header;
...
var eGridDiv = document.getElementById("myGridAt");
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/area_tagih/save_area_tagih_add",
          type: "post",
  ...
  showCommonDialog(
    ...
    800,
    "ADD AREA TAGIH",
    GLOBAL_MAIN_VARS["SITE_URL"] + "settings/area_tagih/area_tagih_add_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/area_tagih/save_area_tagih_edit",
            type: "post",
            success: showFormResponse,
            dataType: "json",
          };
    ...
    showCommonDialog(
      ...
      "EDIT AREA TAGIH",
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "settings/area_tagih/area_tagih_edit_form?id=" +
        selr,
      buttons
    );
  } else {

...
var gridOptions = {
  ...
  onCellClicked: (params) => {
    ...
    selr = params.data.id;
    deviation_id = params.data.deviation_id;
    ...
    bootbox.confirm(
      ...
      function (result) {
        if (result) {
          $.get(
            GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/deviation_reference_temp/save_deviation_reference_edit_temp",
            {
              id: selr,
  ...
  if (selr) {
    bootbox.confirm("Are you sure to reject this request ?", function (result) {
      if (result) {
        $.get(
          GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/deviation_reference_temp/save_note_reject_deviation_reference",
          {
            id: selr,
          },
          function (data) {

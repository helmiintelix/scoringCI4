...
function search_param(param) {
  ...
  $.ajax({
    ...
    url:
      URL_DATA +
      "workflow_pengajuan/workflow_pengajuan_restructure/cek_config_rest",
    data: data1,
    dataType: "json",
    //timeout: 3000,
...
function get_data_perhitungan_kotak_merah() {
  ...
  $.ajax({
    ...
    url:
      URL_DATA +
      "workflow_pengajuan/workflow_pengajuan_restructure/get_data_kotak_merah",
    data: {
      due_date: due_date,
  ...
  swal({
    ...
    if (willDelete) {
      ...
      $.ajax({
        url:
          URL_DATA +
          "workflow_pengajuan/workflow_pengajuan_restructure/save_pengajuan_restructure?status=" +
          $flag,
        type: "post",
...
function jadwal_pebayaran() {
  ...
  showCommonDialog3(
    ...
    URL_DATA +
      "workflow_pengajuan/workflow_pengajuan_restructure/payment_plan?tipe=" +
      tipe +
      "&tenor=" +
      tenor +
      "&hutang=" +
...
function get_new_installment_amount(
  ...
  $.ajax({
    ...
    url:
      URL_DATA +
      "workflow_pengajuan/workflow_pengajuan_restructure/get_new_installment_amount?tipe=" +
      tipe +
      "&tenor=" +
      tenor +
      "&hutang=" +
  ...
  function getCsrfToken() {
    return new Promise((resolve, reject) => {
      $.ajax({
        ...
        url:
          GLOBAL_MAIN_VARS["SITE_URL"] +
          "workflow_pengajuan/workflow_pengajuan_restructure/get_csrf_token",
        dataType: "json",
        success: function (msg) {
          resolve(msg);
        },

...
function getData() {
  $.ajax({
    url:
      ...
      "pengiriman_surat/upload_pengiriman_surat/get_pengiriman_surat_file_list" +
      classification,
    type: "get",
...
$("#btn-upload").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "pengiriman_surat/upload_pengiriman_surat/save_file",
          type: "post",
          dataType: "json",
          success: function (msg) {
            if (msg.success == true) {
                ...
                success: {
                  ...
                  callback: function () {
                    var options = {
                      url:
                        GLOBAL_MAIN_VARS["SITE_URL"] +
                        "pengiriman_surat/upload_pengiriman_surat/upload_file",
                      type: "post",
                      data: {
                        id: msg.id,
                      },
              ...
              showCommonDialog(
                800,
                800,
                "UPLOAD PENGIRIMAN SURAT FILE",
                GLOBAL_MAIN_VARS["SITE_URL"] +
                  "pengiriman_surat/upload_pengiriman_surat/show_uploaded_file_form?id=" +
                  msg.id,
                buttons
              );
            }
  ...
  showCommonDialog(
    ...
    "UPLOAD PENGIRIMAN SURAT FILE",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "pengiriman_surat/upload_pengiriman_surat/upload_file_form",
    buttons
  );
});

...
function getData() {
  $.ajax({
    url:
      ...
      "user_and_group/user_group_management/user_group_management_list",
    type: "get",
...
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "user_and_group/user_group_management/save_user_group_edit",
            type: "post",
    ...
    showCommonDialog(
      ...
      "Edit Team",
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "user_and_group/user_group_management/user_group_edit_form?id=" +
        selr,
      buttons
    );
  } else {
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "user_and_group/user_group_management/save_user_group_add",
          type: "post",
  ...
  showCommonDialog(
    ...
    "ADD USER GROUP",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "user_and_group/user_group_management/user_group_add_form",
    buttons
  );
});
    ...
    bootbox.confirm(
      ...
      function (result) {
        if (result) {
          $.post(
            GLOBAL_MAIN_VARS["SITE_URL"] +
              "user_and_group/user_group_management/remove_user_group/",
            { id_user: selr },
            function (data) {

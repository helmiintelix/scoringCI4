...
function getData() {
  $.ajax({
    url:
      ...
      "reports/report_visit_radius/get_report_visit_radius" +
      classification,
    type: "get",
...
var eGridDiv = document.getElementById("myGridRvlrg");
...
var TrackingAgent = function (long, lat, user_id) {
  ...
  showCommonDialog(
    ...
    "TRACKING",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "reports/report_visit_radius/tracking_history?user_id=" +
      user_id +
      buttons
  );
};

...
function getData() {
  $.ajax({
    url:
      ...
      "reportCols/load_visit_field_collection/get_report_visit_field_list" +
      classification,
    type: "get",
...
var eGridDiv = document.getElementById("myGridLvfc");
...
$("#btn-search").click(function () {
  ...
  var no_pinjaman = $("#txt-no-pinjaman").val();
  var product = $("#opt-product").val();
  var bucket = $("#opt-bucket").val();
  var user = $("#opt-user").val();

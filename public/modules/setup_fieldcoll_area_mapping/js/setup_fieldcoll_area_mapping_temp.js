...
var gridOptions = {
  ...
  onCellClicked: (params) => {
    ...
    selr = params.data.id;
    area_tagih_id = params.data.area_tagih_id;
    ...
    bootbox.confirm(
      ...
      function (result) {
        if (result) {
          $.get(
            GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/fieldcoll_area_mapping_temp/save_fieldcoll_area_mapping_edit_temp",
            {
              id: selr,
            },
            function (data) {
  ...
  if (selr) {
    bootbox.confirm("Are you sure to reject this request ?", function (result) {
      if (result) {
        $.get(
          GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/fieldcoll_area_mapping_temp/save_note_reject_fieldcoll_area_mapping",
          {
            id: selr,
          },
          function (data) {

...
function getData() {
  $.ajax({
    url:
      ...
      "settings/fieldcoll_area_mapping/fieldcoll_area_mapping_list" +
      classification,
    type: "get",
...
function getDataApproval() {
  $.ajax({
    url:
      GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/fieldcoll_area_mapping_temp/fieldcoll_area_mapping_list_temp" +
      classification,
    type: "get",
    success: function (msg) {
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/fieldcoll_area_mapping/save_fieldcoll_area_mapping_add",
          type: "post",
  ...
  showCommonDialog(
    800,
    800,
    "ADD FIELDCOLL AREA MAPPING",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/fieldcoll_area_mapping/fieldcoll_area_mapping_add_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/fieldcoll_area_mapping/save_fieldcoll_area_mapping_edit",
            type: "post",
            success: showFormResponse,
            dataType: "json",
          };
    ...
    showCommonDialog(
      800,
      800,
      "EDIT FIELDCOLL AREA MAPPING",
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "settings/fieldcoll_area_mapping/fieldcoll_area_mapping_edit_form?id=" +
        selr,
      buttons
    );
  } else {

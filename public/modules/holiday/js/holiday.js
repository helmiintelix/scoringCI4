...
function getData() {
  $.ajax({
    url:
      ...
      "holiday/holiday_maker/holiday_list" +
      classification,
    type: "get",
...
function getDataApproval() {
  $.ajax({
    url:
      GLOBAL_MAIN_VARS["SITE_URL"] +
      "holiday/holiday_temp/holiday_list_temp" +
      classification,
    type: "get",
    success: function (msg) {
...
var eGridDiv = document.getElementById("myGridHc");
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "holiday/holiday_maker/save_holiday_add",
          type: "post",
  ...
  showCommonDialog(
    ...
    800,
    "ADD HOLIDAY",
    GLOBAL_MAIN_VARS["SITE_URL"] + "holiday/holiday_maker/holiday_add_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "holiday/holiday_maker/save_holiday_edit",
            type: "post",
            success: showFormResponse,
            dataType: "json",
          };
    ...
    showCommonDialog(
      ...
      "EDIT BRANCH",
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "holiday/holiday_maker/holiday_edit_form?id=" +
        selr,
      buttons
    );
  } else {

...
function getData() {
  $.ajax({
    url:
      ...
      "settings/balai_lelang/balai_lelang_list" +
      classification,
    type: "get",
...
var gridOptions = {
  ...
  onCellClicked: (params) => {
    ...
    selr = params.data.balai_id;
    selected_data = params.data;
  },
};
var eGridDiv = document.getElementById("myGridMah");
...
$("#btn-add").click(function () {
    ...
    success: {
      ...
      callback: function () {
        var options = {
          url:
            GLOBAL_MAIN_VARS["SITE_URL"] +
            "settings/balai_lelang/save_balai_lelang",
          type: "post",
  ...
  showCommonDialog(
    ...
    "ADD ACTION HOUSE",
    GLOBAL_MAIN_VARS["SITE_URL"] +
      "settings/balai_lelang/balai_lelang_add_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
      ...
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] +
              "settings/balai_lelang/save_edit_balai_lelang",
            type: "post",
            success: showFormResponse,
            dataType: "json",
          };
    ...
    showCommonDialog(
      ...
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "settings/balai_lelang/balai_lelang_edit_form?id=" +
        selr,
      buttons
    );
  } else {
  ...
  if (selr) {
    bootbox.confirm(
      ...
      function (result) {
        if (result) {
          $.post(
            GLOBAL_MAIN_VARS["SITE_URL"] + "settings/balai_lelang/del_mBalai",
            {
              id: selr,

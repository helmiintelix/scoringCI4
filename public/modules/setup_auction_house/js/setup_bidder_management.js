...
var eGridDiv = document.getElementById("myGridSbm");
...
$("#btn-add").click(function () {
  var buttons = {
    success: {
      ...
      callback: function () {
        var options = {
          url: GLOBAL_MAIN_VARS["SITE_URL"] + "settings/bidder/save_bidder",
          type: "post",
  ...
  showCommonDialog(
    ...
    800,
    "ADD BIDDER",
    GLOBAL_MAIN_VARS["SITE_URL"] + "settings/bidder/bidder_form",
    buttons
  );
});
$("#btn-edit").click(function () {
  if (selr) {
    var buttons = {
      success: {
        ...
        callback: function () {
          var options = {
            url:
              GLOBAL_MAIN_VARS["SITE_URL"] + "settings/bidder/save_bidder_edit",
            type: "post",
            success: showFormResponse,
            dataType: "json",
          };
    ...
    showCommonDialog(
      ...
      "EDIT BIDDER",
      GLOBAL_MAIN_VARS["SITE_URL"] +
        "settings/bidder/bidder_edit_form?id=" +
        selr,
      buttons
    );
  } else {
  ...
  if (selr) {
    bootbox.confirm(
      ...
      function (result) {
        if (result) {
          $.post(
            GLOBAL_MAIN_VARS["SITE_URL"] + "settings/bidder/del_bidder",
            {
              id: selr,

...
; (function ($, window, document, undefined) {
    ...
    var templates = {
        ...
        treeviewItem: '<div role="treeitem" class="list-group-item show" data-bs-toggle="collapse"></div>',
        treeviewGroupItem: '<div role="group" class="list-group collapse show" id="itemid"></div>',
    ...
    $.extend(bstreeView.prototype, {
        ...
        build: function (parentElement, nodes, depth) {
            ...
            $.each(nodes, function addNodes(id, node) {
                ...
                if (node.lovType) {
                    treeItem.attr('lovType', node.lovType);
                }

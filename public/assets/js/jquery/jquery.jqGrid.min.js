...
"</div>"),a("tr",t).append(p),a(p,t).attr({title:b.refreshtitle||"",id:"refresh_"+u}).click(function(){if(!a(this).hasClass("ui-state-disabled")){a.isFunction(b.beforeRefresh)&&b.beforeRefresh.call(m);m.p.search=!1;m.p.resetsearch=!0;try{if("currentfilter"!==b.refreshstate){var c=m.p.id;m.p.postData.filters="";try{a("#fbox_"+a.jgrid.jqID(c)).jqFilter("resetFilter")}catch(d){}a.isFunction(m.clearToolbar)&&m.clearToolbar.call(m,!1)}}catch(e){}switch(b.refreshstate){case "firstpage":a(m).trigger("reloadGrid",
[{page:1}]);break;case "current":case "currentfilter":a(m).trigger("reloadGrid",[{current:!0}])}a.isFunction(b.afterRefresh)&&b.afterRefresh.call(m)}return!1}).hover(n,s),p=null);p=a(".ui-jqgrid").css("font-size")||"11px";a("body").append("<div id='testpg2' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:"+p+";visibility:hidden;' ></div>");p=a(t).clone().appendTo("#testpg2").width();a("#testpg2").remove();a(v+"_"+b.position,v).append(t);m.p._nvtd&&(p>m.p._nvtd[0]&&(a(v+"_"+b.position,
v).width(p),m.p._nvtd[0]=p),m.p._nvtd[1]=p);t=p=p=null;this.nav=!0}}}})},navButtonAdd:function(d,b){b=a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"},b||{});return this.each(function(){if(this.grid){"string"===typeof d&&0!==d.indexOf("#")&&(d="#"+a.jgrid.jqID(d));var f=a(".navtable",d)[0],c=this;if(f&&(!b.id||void 0===a("#"+a.jgrid.jqID(b.id),f)[0])){var h=a("<td></td>");"NONE"===b.buttonicon.toString().toUpperCase()?a(h).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>"+
...
0<x.idx?' style="display:none;" ':" ")+'role="row" class= "ui-widget-content jqgroup ui-row-'+g.p.direction+" "+r+'"><td style="padding-left:'+12*x.idx+'px;" colspan="'+e+'">'+m+a.jgrid.template(k.groupText[x.idx],n,x.cnt,x.summary)+"</td></tr>";if(t-1===x.idx){var A=k.groups[c+1],J,B=0;J=x.startRow;var M=void 0!==A?A.startRow:k.groups[c].startRow+k.groups[c].cnt;k._locgr&&(B=(b-1)*f,B>x.startRow&&(J=B));for(;J<M&&d[J-B];J++)l+=d[J-B].join("");if("header"!==k.groupSummaryPos[x.idx]){var H;if(void 0!==

...
var callAlert = function (callerId, number, customerData, recordingId){
	...
	try {
		...
		var arrCustomerData = customerData.split("XXXXXXX");
		
		GLOBAL_MAIN_VARS['nomor_kontrak'] = arrCustomerData[0];
		GLOBAL_MAIN_VARS['flag'] = null;
		GLOBAL_MAIN_VARS['class_id'] = arrCustomerData[1];
		GLOBAL_MAIN_VARS['active_call_no'] = number;
		
		loadDataCustomer(arrCustomerData[0],null);
	}
	catch (ex){
		TELEPHONY_LOG.error(
